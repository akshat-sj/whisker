disk_load:
  ...
  mov ah,0x02 ; set ah register to read mode (accumulator)
  mov al, dh ; read dh number of sectors
  mov cl,0x02 ; cl is our starting sector (2), sector 1 is out boot sector
  ...
  jne sectors_error ;else we jump to sector error 
  popa
  ret
