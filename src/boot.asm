...
BOOT_DRIVE db 0 ; this is the byte that stores the boot drive number that bios understands to load the boot sector
...
mov bp,0x8FOO ;stack here is set up with bottom pointeer, we place it at the following adress so we have enough space for the stack to grow downwards and avoid collisions
